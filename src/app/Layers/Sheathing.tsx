...
const Sheathing: React.FC<ArmouringProps> = ({ selectedLayer }) => {
  ...
  useEffect(() => {
    ...
    const finalArmourRadius = beddingOuterRadius + ArmouringWireDiam;
    ...
    if(subtype==="Solid" || subtype==="Concentric") {
      ...
      // ✅ Sheathing layer added outside the armouring wires
      const sheathingRadius = finalArmourRadius +ArmouringWireDiam+SheathingThickness;


      svg.append("circle")
        .attr("cx", centerX)
        .attr("cy", centerY)
        .attr("r", sheathingRadius-1)
        .attr("fill", "none")
        .attr("stroke", SheathingColour)
        .attr("stroke-width", SheathingThickness );
    }
    ...
    if(subtype==="Compacted") {
      ...
      const sheathingRadius = finalArmourRadius +ArmouringWireDiam+SheathingThickness+1.5;


      svg.append("circle")
        .attr("cx", centerX)
        .attr("cy", centerY)
        .attr("r", sheathingRadius)
        .attr("fill", "none")
        .attr("stroke", SheathingColour)
        .attr("stroke-width", SheathingThickness );
    }
